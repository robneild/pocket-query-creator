 ...
 * 
 */
public class Dialog2 extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Fist stage in wizard so create data store
        queryStore = new QueryStore(getApplicationContext());

        // Create list of filters, adding each one
        
        _filterList = new ArrayList<FilterOption>();
        this.m_adapter = new OrderAdapter(this, R.layout.dialog2_1_list, _filterList);
        ...
        FilterOption filterOption = new FilterOption(getResources().getString(R.string.filter_checkboxes), R.drawable.tick,
                getResources());
        filterOption.setFilterValue(Prefs.getCheckBoxesFilter(this), getResources());
    ...
    private Dialog createDialog(int id) {
        ...
        if (id == 0) {
            // Cache type
            CheckBoxesFilter checkBoxesFilter = Prefs.getCheckBoxesFilter(Dialog2.this);
            ...
            return new AlertDialog.Builder(this).setTitle(R.string.filter_checkboxes)
                    .setMultiChoiceItems(options, selections, new DialogInterface.OnMultiChoiceClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Prefs.saveCheckBoxesFilter(getApplicationContext(), checkBoxesFilter);
        ...
        if (id == 1) {
            ...
            final boolean[] selections = Prefs.getCacheTypeFilter(Dialog2.this).getAsBooleanArray();
            ...
            return new AlertDialog.Builder(this).setTitle(R.string.filter_cache_type)
                    .setMultiChoiceItems(options, selections, new DialogInterface.OnMultiChoiceClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Prefs.saveCacheTypeFilter(getApplicationContext(), cacheTypeList);
        ...
        if (id == 2) {
            ...
            for (int i = 0; i < options.length; i++) {
                options[i] = getApplicationContext().getResources()
                        .getString(ContainerType.values()[i].getResourceId());
            }
            final boolean[] selections = Prefs.getContainerTypeFilter(Dialog2.this).getAsBooleanArray();
            ...
            return new AlertDialog.Builder(this).setTitle(R.string.filter_container)
                    .setMultiChoiceItems(options, selections, new DialogInterface.OnMultiChoiceClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Prefs.saveContainerTypeFilter(getApplicationContext(), containerTypeList);
        ...
        if (id == 3)
            return CreateDialog(R.string.filter_terrain, Prefs.getTerrainFilter(this), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Prefs.saveTerrainFilter(Dialog2.this, newOneToFiveFilter);
        ...
        if (id == 4)
            return CreateDialog(R.string.filter_difficulty, Prefs.getDifficultyFilter(this), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Prefs.saveDifficultyFilter(Dialog2.this, newOneToFiveFilter);
    ...
    private AlertDialog CreateDialog(int titleRes, OneToFiveFilter initialValue, DialogInterface.OnClickListener okHandler) {
        ...
        LinearLayout view = (LinearLayout) getLayoutInflater().inflate(R.layout.dialog_signin, null);
