...
//import org.pquery.webdriver.parser.Parser;
//import org.pquery.webdriver.parser.SuccessMessageParser;
//import org.pquery.webdriver.parser.Parser.ParseException;
//
...
//
//public class CreateAsync extends AsyncTask<Void, ProgressInfo, ResultInfo> implements LocationListener {
//
//    private Resources res;
//    private Context cxt;
//
//    private SuccessMessageParser successMessageParser;
//
...
//    
//    public CreateAsync(boolean debug, Context cxt, QueryStore queryStore, LocationManager locationManager) {
...
//        this.download = Prefs.getDownload(cxt);
//
...
//                        return new FailureResult(res.getString(R.string.gps_timeout));
//                } finally {
//                    stopGPS();
//                }
//            }
...
//            while (retry >= 0) {
//                checkCancelled();
//                Failure failure = doLogin();
//                Logger.d("doLogin returned " + failure);
//
//                if (failure == null)
//                    break;
//
//                if (retry == 0)
//                    return new FailureResult(failure.toHTML());
//
//                retry--;
//                for (int i = 60; i > 0; i--) { // display second countdown
//                    checkCancelled();
//                    publishProgress(new ProgressInfo(5, failure.toHTML() + "<br><br>Will try again in " + i
//                            + " seconds"));
//                    Thread.sleep(1000);
//                }
//            }
...
//                Logger.d("create returned " + failure);
//
//                if (failure == null)
//                    break;
//
...
//                // now
//                return new SuccessResult(successMessageParser.toString(res));
//            }
//
//            // 60% - 70%
//            checkCancelled();
...
//            Thread.sleep(30000);
//
//            String downloadPath = successMessageParser.extractDownloadGuid();
//
//            // 70%
//            retry = retryCount;
//            while (retry >= 0) {
//                checkCancelled();
//                Failure failure = openOutputFile();
//                Logger.d("openOutputFile returned " + failure);
//
//                if (failure == null)
//                    break;
//
...
//                for (int i = 60; i > 0; i--) { // display second countdown
//                    checkCancelled();
//                    publishProgress(new ProgressInfo(70, failure.toHTML() + "<br><br>Will try again in " + i
//                            + " seconds"));
//                    Thread.sleep(1000);
//                }
//            }
...
//            while (retry >= 0) {
//                checkCancelled();
//                Failure failure = download(downloadPath);
//                Logger.d("download returned " + failure);
//
//                if (failure == null)
//                    break;
//
...
//            }
//
//            return new SuccessResult("Downloaded Pocket Query containing " + successMessageParser.extractNumberPQ()
//                    + " caches<font color=green><br>[" + outputFile.getAbsolutePath() + "]</font>");
//
...
//            return new FailureResult(res.getString(R.string.service_cancelled));
//        } catch (FailureDontRetry e) {
...
//     */
//    public Failure create() throws FailureDontRetry {
//
